...
function OptionalNote(){
	...
	$('body').append(' <div id="optionalNote" style="position:fixed;top:200px;left:45%;background-color:#fff;box-shadow: 0px 0px 5px black;width:auto;height:auto;padding: 10px;"><div style="pointer-events: none;text-align:center;">Any notes to add ?</div><div style="margin-top:10px;"><textarea style="margin: 0px; width: 429px; height: 149px;"></textarea><br><button value="Submit Note" id="submitNote" style="float: right;border: none;background-color: #0077d4;color: #fff;padding: 5px;font-size: 12px;cursor:pointer;">Submit Note</button><button value="Submit Note" id="submitNote" style="float: left;border: none;background-color: #0077d4;color: #fff;padding: 5px 20px 5px 20px;font-size: 12px;cursor:pointer;">Skip</button></div>  </div>  ');
